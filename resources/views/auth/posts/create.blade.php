            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('imgCover') is-invalid @enderror" id="imgCover" name="imgCover" accept="image/*">
                        @error('imgCover')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="keywords" class="form-control @error('keywords') is-invalid @enderror" name="keywords" value="{{ old('keywords') }}">
                        @error('keywords')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <textarea id="meta_description" class="form-control @error('meta_description') is-invalid @enderror" name="meta_description" rows="2">{{ old('meta_description') }}</textarea>
